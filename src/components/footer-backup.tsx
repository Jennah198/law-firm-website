...
const legalLinks = [
  { name: "Privacy Policy", href: "https://en.wikipedia.org/wiki/Privacy_policy#:~:text=A%20privacy%20policy%20is%20a,a%20customer%20or%20client's%20data." },
  { name: "Terms of Service", href: "https://en.wikipedia.org/wiki/Terms_of_service" },
  { name: "Cookie Policy", href: "https://commission.europa.eu/cookies-policy_en" },
  { name: "Disclaimer", href: "https://en.wikipedia.org/wiki/Disclaimer" },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12">
          ...
          <div className="max-w-2xl mx-auto">
            <Link
              href="https://maps.google.com/?q=123+Legal+Street+Suite+456+City+State+12345"
              target="_blank"
              ...
              <div className="relative overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="bg-gray-800 h-48 flex items-center justify-center">
                  <div className="text-center">
                    <MapPin className="h-12 w-12 text-brand-gold-400 mx-auto mb-3" />
                    <p className="text-white font-medium mb-2">123 Legal Street, Suite 456</p>
                    <p className="text-gray-300 text-sm">City, State 12345</p>
                    <div className="mt-3 inline-flex items-center text-brand-gold-400 text-sm font-medium group-hover:text-brand-gold-300 transition-colors duration-300">
