...
const slides: SlideData[] = [
  {
    id: 1,
    title: "Investment",
    subtitle: "Law in Ethiopia",
    imageSrc: "/sadam-office.jpg"
  },
  {
    id: 2,
    title: "Corporate",
...
export function HeroSlider() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      >
        <div className={`w-4 h-4 ${isAutoPlaying ? 'bg-white' : 'bg-white/70'}`}>
          {isAutoPlaying ? (
